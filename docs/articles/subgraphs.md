...
```
    ...
    ##   `/tmp/Rtmp6xgijc/temp_libpath8c3932b2ce99/spdep/etc/shapes/GB_2024_Wales_50m.gpkg.zip' 
    ##   using driver `GPKG'
...
```
    ...
    ##   `/tmp/Rtmp6xgijc/temp_libpath8c3932b2ce99/spdep/etc/shapes/tokyo.gpkg.zip' 
    ##   using driver `GPKG'
