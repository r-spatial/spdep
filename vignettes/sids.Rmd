...
We will be using the **spdep** package, here version: `r spdep()[1]`, the **sf** package and the **tmap** package. The data from the sources
...
(<http://colorbrewer.org>) colour palettes. Here we use 
